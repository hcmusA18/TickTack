...
import type { PersistNavigationConfig } from 'configs/config.base'
import { useIsMounted } from 'libs/utils/useIsMounted'
 ...
 */
export const navigationRestoredDefaultState = (persistNavigation: PersistNavigationConfig) => {
...
/**
 * Hook that handles persisting navigation state.
 */
export const useNavigationPersistence = (storage: Storage, persistenceKey: string | null) => {
